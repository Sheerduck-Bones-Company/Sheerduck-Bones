...
class Camera(pygame.sprite.Group):
	def __init__(self, game):
		...
		self.interact_img = pygame.image.load(f"{FILE_PATH}/assets/graphics/buttons/E.png")
	...
	def custom_draw(self,target):
		...
		#Si le joueur est proche d'un bloc intéractif, on affiche l'image de la touche E
